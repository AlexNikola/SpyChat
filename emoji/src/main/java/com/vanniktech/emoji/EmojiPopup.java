...
public final class EmojiPopup {
    ...
    private final ViewTreeObserver.OnGlobalLayoutListener onGlobalLayoutListener = new ViewTreeObserver.OnGlobalLayoutListener() {
        ...
        public void onGlobalLayout() {
            ...
            Log.d("dvddgvdf", "onGlobalLayout isKeyboardOpen " + isKeyboardOpen);
        }
    };
    ...
    public void toggle() {
        ...
        Log.d("dvddgvdf", "popupWindow.isShowing() " + popupWindow.isShowing());
        Log.d("dvddgvdf", "isKeyboardOpen " + isKeyboardOpen);
