...
public class MyDbHelper extends SQLiteOpenHelper
{
    ...
    {
        String sql = "SELECT * FROM "+ Countries.TABLE_NAME;
        Cursor cursor = db.rawQuery(sql, null);
        ...
        if (cursor.moveToFirst())
        {
            do
            {
                ...
                String nameNative = cursor.getString(2);
                String codeISO = cursor.getString(0);
